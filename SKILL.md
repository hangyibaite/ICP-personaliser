...
description: >
  Build a hyper-specific Ideal Client Profile (ICP) through guided conversation. Use this skill whenever someone asks to define their ICP, ideal client, target customer, avatar, who they sell to, who they serve, or wants help figuring out their target market. Also trigger on "help me find my niche," "who should I sell to," "define my audience," "build my avatar," "who is my customer," or any request to create an ICP document. This skill runs a structured interview, challenges vague answers, and produces a tailored ICP markdown document. Always use this skill even if the request seems simple — a proper ICP requires guided extraction, not guesswork.
---
...
|---|---|---|
| `references/question-framework.md` | Always, before starting | Full questioning sequence across 10 rounds, output template |
| `references/ambiguity-handling.md` | Always, before starting | How to handle vague, thin, or confused answers |
| `references/synthesis.md` | Before every checkpoint and final output | Rules for summarising and confirming back |
...
After every major section, synthesize using the rules in `references/synthesis.md` and confirm before proceeding. The "What You Actually Do" checkpoint is mandatory — do not proceed without explicit confirmation.
...
Once all rounds are complete and confirmed, generate a single markdown document following the output template in `references/question-framework.md`. Apply the synthesis rules from `references/synthesis.md`.
